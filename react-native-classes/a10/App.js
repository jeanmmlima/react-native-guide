...
function VariavelPelaPlataforma() {
...
function ImageInternet() {
  ...
  return (
    <SafeAreaView style={styles.AndroidSafeArea}>
      <View style={styles.container}>
        <Image style={{ width: '95%', height: '70%' }} source={{ uri: 'http://reactjs.org/logo-og.png' }} />
        <StatusBar style='auto' />
      </View>
